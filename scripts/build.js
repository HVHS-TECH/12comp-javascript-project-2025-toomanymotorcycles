let doorClearances = [{clearance: 1, locked: true}]

function createDoor(tile, clearance, voicelocked) {
    newDoor = new Door(tile.x+32,tile.y-160,0,2,4500)
...
wallTopCorner2.tile = "R";
    ...
    for (i=0; i<lczFloorBigDoor.length; i++) {
        createDoor(lczFloorBigDoor[i],doorClearances[i].clearance,doorClearances[i].locked);
    }
};
